...
public class MainActivityLab5_2Music extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lab5_2_layout_music);
        mPlayer=MediaPlayer.create(this, R.raw.singtome);
